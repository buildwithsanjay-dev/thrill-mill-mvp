...
export const THEMES: Record<string, Theme> = {
  ...
  "thrill-mill": {
    // Matches the actual Thrill Mill Club app palette — the dark navy used
    // for its confirm bars (#0F1729), the bright teal used as the dark-mode
    // primary accent (#1BB6A6), and an off-white close to the app's own
    // screen background (#F6F8FA) — not a generic preset.
    id: "thrill-mill",
    name: "Thrill Mill",
    bg: "#0F1729",
    bgAlt: "#F6F8FA",
